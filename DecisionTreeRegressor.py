...
def apply_kmeans(df, n_clusters=3):
    ...
    return df, centroids
def apply_decision_tree_model(df, suitable_df):
    ...
    print(f"Decision Tree Regression Performance: R² Score = {r2:.4f}, MAE = {mae:.4f}")    
...
if __name__ == "__main__":
    file_path1 = r'C:\Users\naina\Downloads\Resume Project\ML Based Coral Water Analysis and Optimization\Regression Algorithm\Decision Tree Regressor\near_suitable_data.csv'
    ...
    file_path2 = r'C:\Users\naina\Downloads\Resume Project\ML Based Coral Water Analysis and Optimization\Regression Algorithm\Decision Tree Regressor\suitable.csv'
    suitable_df = pd.read_csv(file_path2)
    far_unsuitable_adjusted = apply_decision_tree_model(far_unsuitable_adjusted, suitable_df)   
